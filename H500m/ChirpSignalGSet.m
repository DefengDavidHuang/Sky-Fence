...
plane_height = 500; 100; %500.1; %101.1; %500; %1.0e4;  %1.0e3; %
plane_speed = 20; %100.1; %300.1; %100.1; %10; %30; %plane speed in m/s

width_z = 0.33*2; %0.17; %0.33; %6.4; %1; %2.1; %6.1; %length of plane
length_x = 0.45*2; % 0.25; %0.45; % 8.1; %3.1; %8.1; %width of plane  %x: parallel to ground and perpendicular to the satellite link
...
total_time = 0.5; %0.3; %2; %5; %2; %0.6; %0.6; %1; %8; %10.0; %5.0; %1.0; %0.1; %0.25; %0.5; %2; %5; %1; %3; %0.3; %3; % 0.3; %3; %0.3; %5e-3; % %0.1; %0.6; %0.6; %0.0006; % % second  
...
savefilename = strcat(test5,'signal02seconddroneset250mintotalDJI500mlarge.mat');
