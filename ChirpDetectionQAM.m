...
data_length = 1000; %100; %5000; %10000; %5000; %1000; %100; %10000; %1000; %5000; %1000; %10000; %1000; %10000; %10000; %5000; %1000; % 5000; % 50; %10; %100; %5000; %1000; %5000; %1000; %1000; %5000; %10000; %5000; %100; %5000; %1; %10000; %1000; %10000;
...
for j2 = 1:1:length(Vec_T)
 ...
 for j1 = 1:1:Max_trials
  ...
  if Num_N0(j2) == Max_Num_errors
      Total_trials(j2) = j1
      save('290ChirpRoC1000D10dBQAMtemp','Num_N0','Num_N1','Total_trials','Vec_T');
      break;
  end
 end
 if j1 == Max_trials
