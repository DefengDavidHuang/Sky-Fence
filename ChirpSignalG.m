...
plane_speed = 100.1; %10; %30; %108km/hour %0; %-250; %0; %150; %250; %-250; % %-125% -250; %-600; %-50; %600; %250; %0; % %-600; %-50; %  -250; % %600; % %600; % % %600; %200;   0; %50; % %250m/second = 900km/hour

time_step = 0.00041; %0.0021; %0.00021; %0.00051; %0.000051; %05;
total_time = 0.3; %2; %5; %2; %0.6; %0.6; %1; %8; %10.0; %5.0; %1.0; %0.1; %0.25; %0.5; %2; %5; %1; %3; %0.3; %3; % 0.3; %3; %0.3; %5e-3; % %0.1; %0.6; %0.6; %0.0006; % % second  
...
width_z = 6.1; %length %8.1; %40; %40; %20; %20; %20; %10; %4; %2; %0; %0; %10; %20; %20; %20.0;
length_x = 8.1; %width 1.01% 6.1; %20; %20; %10; %10; %10; %4; % 2; %0; %10; %0; %20; %20.0;    %x: parallel to ground and perpendicular to the satellite link
...
savefilename = strcat(test5,'signal02second.mat');
 %}
...
for m = 1:1:Num_data_point
 ...
 % y_FK = 20*log10(output_FKMPSK);
  ...
  save(savefilename,'x_time','y_FK','output_N0','Vdoppler','Vbound','outputgain_N1','outputgain_target','outputgain_N0');
