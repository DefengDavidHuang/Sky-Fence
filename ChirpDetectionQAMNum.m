...
data_length = 100; %1000; %5000; %10000; %5000; %1000; %10000; %5000; %1000; %10000; %5000; %150; %10; %50; %10; %100; %100; %10; %100; %1000; %5000; %1000; %10000; %5000; %1000; %10000; %1000; %5000; %1000; %1000; % 5000; %100; %10000; %1000; %10000;

%Vec_T = 0.012:0.0001:0.016; %10000symbols
%Vec_T = 0.0010:0.0002:0.0090;   %1000 symbols, 20dB
%Vec_T = 0.0030:0.0001:0.0050;   %5000 symbols
Vec_T = 0.04:0.001:0.055;
...
for j2 = 1:1:length(Vec_T)
 ...
 for m = 1:1:Num_data_point
  ...
  if Num_N0(j2) == Max_Num_errors
      Total_trials(j2) = j1
      save('51ChirpRoCnum100D10dBQAMtemp','Num_N0','Num_N1','Total_trials','Vec_T');
      break;
  end
 end
 if j1 == Max_trials
