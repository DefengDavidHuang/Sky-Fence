...
output_FKMPSK = y_FK;
output_MPSKN0 = y_FK;
SNR = 1.0; %0.0; %in DB SNR_dB = 0:1:5;   %SNR = 10.1; %20; %10; %10; %3; %10; %10; %in dB
data_length = 1e3; %1e5; %10000; %1000; %5000; %10000; %5000; %1000; %10000; %5000; %1000; %10000; %5000; %150; %10; %50; %10; %100; %100; %10; %100; %1000; %5000; %1000; %10000; %5000; %1000; %10000; %1000; %5000; %1000; %1000; % 5000; %100; %10000; %1000; %10000;

%Vec_T = 0.012:0.0001:0.016; %10000symbols
%Vec_T = 0.0010:0.0002:0.0090;   %1000 symbols, 20dB
%Vec_T = 0.0030:0.0001:0.0050;   %5000 symbols
Vec_T = 0.003:0.00005:0.0038;
...
for j2 = 1:1:length(Vec_T)
 ...
 for m = 1:1:Num_data_point
  ...
  if TN1 > T
      Num_N1(j2) = Num_N1(j2) + 1;  %number with a target
  end
  ...
  if Num_N0(j2) == Max_Num_errors
      Total_trials(j2) = j1
       FalseAlarm = Num_N0 ./ Total_trials
       PoD = Num_N1 ./ Total_trials
      save('201ChirpRoCnum10000D10dBQAMtemp','Num_N0','Num_N1','Total_trials','Vec_T');
      break;
  end
